...
- dir: "."
`,
			expErr: "version: is required. If you've just upgraded Atlantis you need to rewrite your atlantis.yaml for version 2. See www.cloudposse.io/docs/upgrading-atlantis-yaml-to-version-2.html.",
		},
		{
