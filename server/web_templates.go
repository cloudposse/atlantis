...
<div class="container">
  <section class="header">
    <a title="atlantis" href="{{ .CleanedBasePath }}/"><img src="{{ .CleanedBasePath }}/static/images/atlantis-icon_512.png" style="height: 15vw; max-height: 240px; width: auto; max-width: 241px"/></a>
